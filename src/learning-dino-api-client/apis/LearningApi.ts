...
export class LearningApi extends runtime.BaseAPI {
	...
	/**
	 */
	async learningApiSendAnswerPokemonNameCreateRaw(requestParameters: LearningApiSendAnswerPokemonNameCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WasAnswerCorrect>> {
	...
	/**
	 */
	async learningApiSendAnswerPokemonNameCreate(requestParameters: LearningApiSendAnswerPokemonNameCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WasAnswerCorrect> {
